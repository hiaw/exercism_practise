...
defmodule RunLengthEncoderTest do
  ...
  # @tag :skip
  test "it decodes an slightly complicated encoded string" do
    assert RunLengthEncoder.decode("3A3B") === "AAABBB"
  end

  # @tag :skip
  test "it decodes an againe slightly complicated encoded string" do
    assert RunLengthEncoder.decode("13A14B") === "AAAAAAAAAAAAABBBBBBBBBBBBBB"
  end
